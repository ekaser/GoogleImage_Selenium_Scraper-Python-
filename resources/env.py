# Environment
_MULTITHREADING = False #Every class executse as an asynch function. Use with caution
PATH = ".\\"
DATA_DIR = PATH + "data\\" #Best not to change
DATA_NAME = "data.csv"
NEW_DATA = True #Do you want to delete the data folder on execution? Replaced by new data
