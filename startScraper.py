...
from resources.textColors import greenText, blueText, headerText
...
def main() :
    ...
    imagesDownloadedStats = {x : 0 for x in env.CLASSES}
    for manager, thread in imageObjectThreadList:
        ...
        for i, imgObj in enumerate(imgObjects) : #Returns a list of valid image objects
            ...
            imagesDownloadedStats[imgObj.label] += 1
